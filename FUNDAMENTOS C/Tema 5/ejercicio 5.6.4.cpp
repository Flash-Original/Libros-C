/*ejercicoi 5.6.4 Mejorar la base de datos de ficheros(ejemplo 53) para que no permita 
introducir tamaños incorrectos(numeros negativos) ni nombres de fichero vacios.*/
...
///////////////////////////////////////////////////////UwU/////////////////////////////////////
	...
	if(strcmp(fichas[i].nombrefich,textoTemporal)==0)
		printf("Nombre: %s; Tamaño: %1d Kb\n",fichas[i].nombrefich,fichas[i].tamanyo);
		break;
		case 5: /*salir avisemos de que salimos*/
